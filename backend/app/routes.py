...
def check_metrics_files():
    ...
    files_status = {
        ...
        'model_metrics.csv': os.path.exists('Model/model_metrics.csv'),
        'creditcarddata.csv': os.path.exists('Model/creditcarddata.csv'),
        'best_model.pkl': os.path.exists('Model/best_model.pkl'),
        'scaler.pkl': os.path.exists('Model/scaler.pkl')
    }
...
def predict_fraud():
    try:
        ...
        # CORRECTION : Charger le bon modèle (best_model.pkl)

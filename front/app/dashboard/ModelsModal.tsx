...
//             <div>
//               <h2 className="text-2xl font-bold text-slate-900 mb-2">Performance des Modèles IA</h2>
//               <p className="text-slate-600">Analyse comparative des algorithmes de détection de fraude</p>
//             </div>
...
//                 className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 disabled:from-green-300 disabled:to-emerald-300 text-white rounded-xl font-medium disabled:opacity-50 shadow-lg shadow-green-500/25 transition-all duration-200 flex items-center space-x-2"
//               >
